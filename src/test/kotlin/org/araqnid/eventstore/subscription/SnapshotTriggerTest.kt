...
class SnapshotTriggerTest {
    ...
    @Test fun no_snapshot_in_default_state() {
        assertThat<Boolean>(trigger.writeNewSnapshot(), equalTo<Boolean>(false))
        assertThat<Boolean>(trigger.writeInitialSnapshot(), equalTo<Boolean>(false))
    }
    ...
    @Test fun write_initial_snapshot_immediately_after_event_received() {
        trigger.eventReceived(TestPosition(1L))
        assertThat<Boolean>(trigger.writeInitialSnapshot(), equalTo<Boolean>(true))
    }
    ...
    @Test fun write_snapshot_after_event_received_and_quiet_period_has_passed() {
        ...
        assertThat<Boolean>(trigger.writeNewSnapshot(), equalTo<Boolean>(true))
    }
